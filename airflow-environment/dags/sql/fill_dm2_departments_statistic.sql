INSERT INTO dm2_ksusha.departments_statistic(year_finish, dep_id, empl_id, group_id, skill_id, level_id, empl_total_count,
...
dp."senior_%",
dp."expert_%"
FROM dm2_ksusha.dep_data dp
LEFT JOIN dm_ksusha.now n
ON dp.year_finish = n."year"
