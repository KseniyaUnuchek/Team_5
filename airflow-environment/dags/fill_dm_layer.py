...
with DAG(
    ...
    create_schema >> create_tables >> truncate_tables >> fill_table_now >> fill_table_compare >> fill_table_total_change \
    >> fill_table_complex_data >> copy_catalogs >> fill_table_employees_statistic
