...
CREATE TABLE IF NOT EXISTS dm2_ksusha.departments_statistic (
    id SERIAL NOT NULL PRIMARY KEY,
    year_finish INT NOT NULL,
    dep_id INT NOT NULL REFERENCES dm2_ksusha.departments (id),
    empl_id INT NOT NULL REFERENCES dm2_ksusha.employees (id),
    group_id INT NOT NULL REFERENCES dm2_ksusha.skills_group (id),
    skill_id INT NOT NULL REFERENCES dm2_ksusha.skills (id),
    level_id INT NOT NULL REFERENCES dm2_ksusha.levels (id),
